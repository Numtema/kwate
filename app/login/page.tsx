        ...
        <main className="flex-1 flex flex-col">
          <div className="mb-10">
             ...
             <p className="text-zinc-400 text-[15px] font-medium">
               Connectez-vous pour retrouver vos annonces et messages.
             </p>
          </div>
            ...
            <div className="space-y-4 mb-8">
               ...
               <div>
                  <div className="flex items-center justify-between mb-2 pl-4 pr-4">
                     <label className="text-[11px] font-bold text-zinc-500 uppercase tracking-widest">Mot de passe</label>
            ...
            <div className="mt-auto pb-8 pt-6">
               ...
               >
                  {isLoading ? (
                    ...
                    <>
                      Se connecter <LogIn className="w-5 h-5 ml-2 opacity-80" />
                    </>
                  )}
               </button>
               
               <p className="text-center mt-6 text-[14px] font-bold text-zinc-400">
                  Pas encore de compte ? <Link href="/signup" className="text-white hover:text-green-500 transition">S'inscrire</Link>
               </p>
            </div>
          </form>
        </main>
